...
# Set PYTHONPATH
project_root = r"D:\Codes\MS-2D-IMG"
os.environ["PYTHONPATH"] = project_root

select_method = 'entropy'
top_k = 16
...
commands = {
    'ST000923-C8-pos': fr'python dataset_process_workflow.py --dataset_dir E:\msdata\ST000923\HMP2_C8-pos\C8p_rawData --suffix .mzML --mz_min 200 --mz_max 1100 --bin_size 0.01 --num_workers 4 --step patch_selection --select_method {select_method} --top_k {top_k}',
    ...
    'ST003161': fr'python dataset_process_workflow.py --dataset_dir E:\msdata\ST003161_Rawfiles\SOURCE_Israel_Stool_2022_mzml --suffix .mzML --mz_min 65 --mz_max 1010 --bin_size 0.01 --num_workers 4 --step patch_selection --select_method {select_method} --top_k {top_k}',
    'ST003313': fr'python dataset_process_workflow.py --dataset_dir E:\msdata\ST003313_Rawdata\mzml_stool --suffix .mzML --mz_min 65 --mz_max 1010 --bin_size 0.01 --num_workers 4 --step patch_selection --select_method {select_method} --top_k {top_k}',
