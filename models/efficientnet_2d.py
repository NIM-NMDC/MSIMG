...
class EfficientNet2D(nn.Module):
    ...
    def __init__(self, in_channels, num_classes, width_coefficient=1.0, depth_coefficient=1.0, dropout_rate=0.2):
        ...
        self.stem_conv = nn.Conv2d(in_channels, self._round_filters(32), kernel_size=3, stride=2, padding=1, bias=False)
        self.bn0 = nn.BatchNorm2d(self._round_filters(32))
        self.swish = Swish()
        ...
        self.head_conv = nn.Conv2d(self._round_filters(320), self._round_filters(1280), kernel_size=1, bias=False)
        self.bn1 = nn.BatchNorm2d(self._round_filters(1280))
...
def build_efficientnet_2d(args):
